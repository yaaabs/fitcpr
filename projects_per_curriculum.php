    ...
    <div class="col-12">
        <div class="card card-outline card-warning shadow rounded-0">
            <div class="card-body rounded-0">
                <h2 class="text-center mb-4">Archive List of <?= isset($curriculum['name']) ? $curriculum['name'] : "" ?> </h2>
                <p class="text-center"><small><?= isset($curriculum['description']) ? $curriculum['description'] : "" ?></small></p>
                <hr class="bg-navy">
                <?php 
                    ...
                    <a href="./?page=view_archive&id=<?= $row['id'] ?>" class="text-decoration-none text-dark list-group-item list-group-item-action mb-4 p-4 border rounded shadow-sm">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-12">
                                <h3 class="text-navy mb-3"><b><?php echo $row['title'] ?></b></h3>
